...
export default class DigitalMonster {
  ...
  static async put(digitalMonster, id) {
    ...
    SET name = $1
        ...
        tamer = $7
    WHERE id = $8
    RETURNING *`, [digitalMonster.name, digitalMonster.series, digitalMonster.level, digitalMonster.gender, digitalMonster.type, digitalMonster.canDigivolve, digitalMonster.tamer, id])
