...
export default class DigitalMonster {
  ...
  static async create({ name, series, level, attribute, type, canDigivolve, tamer }) {
    const { rows } = await pool.query(`
    INSERT INTO digimon (name, series, level, attribute, type, can_digivolve, tamer)
    VALUES ($1, $2, $3, $4, $5, $6, $7)
    RETURNING *
    `, [name, series, level, attribute, type, canDigivolve, tamer])
  ...
  static async put(digitalMonster, id) {
    ...
    SET name = $1
        ...
        tamer = $7
    WHERE id = $8
    RETURNING *`, [digitalMonster.name, digitalMonster.series, digitalMonster.level, digitalMonster.attribute, digitalMonster.type, digitalMonster.canDigivolve, digitalMonster.tamer, id])
